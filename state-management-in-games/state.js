...
export class StandingLeft extends State {
    constructor(player){
        super('STANDING LEFT'); // STANDING RIGHT is an argument of the constructor (state) in class State
        this.player = player;
    }
    enter(){
        this.player.frameY = 1; // changes sprite sheet animation movement
        this.player.speed = 0;
...
export class SittingLeft extends State {
    constructor(player){
        super('SITTING LEFT'); // SITTING LEFT an argument of the constructor (state) in class State
        this.player = player;
    }
    enter(){
...
export class RunningLeft extends State {
    constructor(player){
        super('RUNNING LEFT'); // SITTING LEFT an argument of the constructor (state) in class State
        this.player = player;
    }
    enter(){
...
export class RunningRight extends State {
    constructor(player){
        super('RUNNING RIGHT'); // SITTING LEFT an argument of the constructor (state) in class State
        this.player = player;
    }
    enter(){
